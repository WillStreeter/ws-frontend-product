...
let NGRxBrokerRegistrationService = class NGRxBrokerRegistrationService {
    constructor(ngrxBrokerConsumer, brokerPublisher) {
...
NGRxBrokerRegistrationService = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NGRxBrokerConsumer,
        BrokerPublisher])
], NGRxBrokerRegistrationService);
export { NGRxBrokerRegistrationService };
