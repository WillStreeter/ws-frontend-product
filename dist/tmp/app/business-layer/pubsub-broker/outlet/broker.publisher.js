...
let BrokerPublisher = class BrokerPublisher extends AbstractBrokerTrader {
    constructor() {
        super();
    }
    NotifyBrokerActionConsumers(brokerAction) {
        this._consumers[0].ReceiveBrokerAction(brokerAction);
    }
    NotifyBrokerSelectorConsumer(brokerRequest) {
