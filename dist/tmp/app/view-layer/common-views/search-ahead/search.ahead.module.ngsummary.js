...
export function SearchAheadModuleNgSummary() {
    return [{ summaryKind: 2, type: { reference: i0.SearchAheadModule, diDeps: [],
                ...
                { reference: i1.ɵm, diDeps: [], lifecycleHooks: [] }, { reference: i1.MdRippleModule,
                    ...
                    diDeps: [], lifecycleHooks: [] }, { reference: i0.SearchAheadModule,
                    diDeps: [], lifecycleHooks: [] }], exportedDirectives: [{ reference: i15.SearchAheadComponent }],
            exportedPipes: [] }, i16.SearchAheadComponentNgSummary, i17.ɵbaNgSummary,
